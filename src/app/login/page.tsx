    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative">
            ...
            <motion.p 
                ...
                // transition={{ duration: 0.6 }}
            >
                Login To Snapcart <Leaf className="w-5 h-5 ml-1 text-green-400" />
            </motion.p>
            ...
            <p className="text-gray-600 mt-6 text-sm flex items-center gap-1">
                Doesn't have an account ? <LogIn className="w-5 h-5 cursor-pointer" /> <span className="text-green-700 font-semibold text-md cursor-pointer" onClick={() => router.push("/register")}>Sign Up</span>
            </p>
        </div>
    )
}
