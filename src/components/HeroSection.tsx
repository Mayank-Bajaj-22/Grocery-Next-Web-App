    ...
    const slides = [
        {
            ...
            btnText: "Shop Now",
            bg: "https://images.unsplash.com/photo-1741515043161-e97d05e5cfcc?q=80&w=1201&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 2,
        ...
        },
        {
            ...
            btnText: "Get Started",
            bg: "https://images.unsplash.com/photo-1723972030485-a90b758fbf44?q=80&w=1931&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
    ]
        ...
        <div className="relative w-[95%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center text-white px-6">
                ...
                >
                    ...
                    <h1 className="text-3xl sm:text-5xl md:text-[57px] font-extrabold tracking-tight drop-shadow-lg">
