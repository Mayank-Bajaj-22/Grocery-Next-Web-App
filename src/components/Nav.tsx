...
export default function Nav({ user }: { user: IUser }) {
    ...
    return (
        <div className="w-[95%] fixed left-1/2 top-4 -translate-x-1/2 bg-linear-to-r from-green-500 to-green-700 rounded-2xl shadow-lg shadow-black/30 flex justify-between items-center h-20 px-4 md:px-8 z-50">
                    ...
                    <AnimatePresence>
                        { open &&
                            ...
                            >
                                ...
                                <Link 
                                    href={""}
                                    className="flex items-center gap-2 px-3 py-3 hover:bg-green-50 rounded-lg font-medium text-gray-700"
                                ...
                                <button 
                                    className="flex items-center gap-2 w-full text-left px-3 py-3 hover:bg-red-50 text-gray-700 font-medium"
                                    onClick={() => {
                                        setOpen(false) 
